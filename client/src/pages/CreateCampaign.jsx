...
const handleFormFieldChange = (fieldName, e) => {
  ...
  return (
    <div className='bg-[#1c1c24] flex justify-items-center items-center flex-col rounded-[10px] sm:p-10 p-4'>
      {isLoading && <Loader text='Transaction is in progress' />}
      <div className='flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43] rounded-[10px]'>
        <h1 className='font-epilogue font-bold sm:text-[18px] leading-[38px] text-white'>Create a Camapign</h1>
      </div>
      <form onSubmit={handleSubmit} className='w-full mt-[65px] flex flex-col gap-[40px]'>
        ...
        <div className='flex flex-wrap gap-[40px]'>
          ...
          <DropDown labelName = 'Category' value = {form.category} handleChange={(e) => setForm({...form, category: e.target.value})}/>
